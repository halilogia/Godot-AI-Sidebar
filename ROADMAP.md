...
- [ ] **v3.1 proje hafızası standardı:** oyun reposunda `GAME_SPEC.md` / `ARCHITECTURE.md` / `ROADMAP.md` / `DECISIONS.md` / `KNOWN_ISSUES.md` şablonları ve skill akışına bağlanması.
