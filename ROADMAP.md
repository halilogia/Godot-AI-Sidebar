...
- [ ] **v3.1 (yeniden) Sidebar skill sistemi:** kullanıcının skill ekleyip çıkarabildiği, eklentinin kendi yöntem paketleri. Önce başka araçların (Claude Code skills, Cursor rules, Cline rules / workflows, Windsurf, Continue, MCP prompts) yaklaşımları araştırılır, tasarım onaylanınca yazılır. Proje hafızası standardı (beş belge) bu tasarımın parçası olarak yeniden değerlendirilir.
