...
const DEFAULT_CONFIG = {
	...
	"temperature": 0.2,
	"max_iterations": 10,
	"system_prompt": "Sen Godot 4.7 motoru içinde çalışan uzman bir yapay zeka oyun geliştirme asistanısın. Görevleri planla, araçları çağır, sahneleri ve kodları düzenle, hataları teşhis et ve doğrula.",
	"language": "tr",
