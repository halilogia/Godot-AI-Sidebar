...
## Inline Onay Kartı (Inline Approval Card) (SRP).
## Yıkıcı veya sahne mutasyon işlemlerinde kullanıcıdan açık onay ister.
...
func _setup_ui() -> void:
	...
	style.bg_color = Color(0.2, 0.16, 0.12, 0.95)
	style.border_color = Color(0.9, 0.6, 0.2, 0.8)
