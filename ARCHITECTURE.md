...
* **[`settings_extras.gd`](addons/godot_sidebar_ai/ui/components/settings_extras.gd):** Ayarlar'ın sahnede olmayan denetimleri: Sağlayıcı → Gelişmiş (yanıt akışı, görüntü desteği otomatik / var / yok), Görünüm & Dil → Onaylar (silmeden önce sor, üzerine yazmadan önce sor). Pencere açılırken yükler, kaydederken config'e yazar.
